...
def insert_module_version(version):
    move_cursor(1,11)
    console.print(f'[white on deep_sky_blue4]{version}[/]')

def insert_module_name(name):
    move_cursor(1,47)
    console.print(f'[white on deep_sky_blue4]{name}[/]')
